...
import { getSteamIdById, getBannedById } from "../query/users.querys.js";
...
export const isBanned = async (req, res, next) => {
     ...
     try {
          ...
          return res.json(errors.response(HTTP_STATUS.FORBIDDEN, "Actualmente estás baneado. Visita El SourceBans para más información. Razón: " + checkBanned[0].reason))
     } catch (err) {
          console.log(err);
