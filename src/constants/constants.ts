...
export enum MatchFoundImages {
     FOUND_ADEPT = 'FOUND_ADEPT.png',
     FOUND_SCOUT = 'FOUND_SCOUT.png',
     FOUND_VETERAN = 'FOUND_VETERAN.png',
     FOUND_UNRANKED = 'FOUND_UNRANKED.png'
}
...
export const API_URL = process.env.NODE_ENV === "production" ? 'https://forsaken-blk.herokuapp.com' : 'http://localhost:5001';
